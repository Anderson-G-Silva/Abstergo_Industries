...
## Introdução
Este relatório apresenta o processo de implementação de ferramentas na empresa Abstergo Industries, realizado por Anderson Gomes da Silva. O objetivo do projeto foi elencar 3 serviços AWS, com a finalidade de realizar diminuição de custos imediatos.
...
## Anexos
- [Anexo 1 - Redução estimada Amazon EC2](https://aws.amazon.com/pt/blogs/aws-cloud-financial-management/five-things-you-should-do-to-create-an-accurate-on-premises-vs-cloud-comparison-model/#:~:text=Cloud%20Financial%20Management-,Five%20things%20you%20should%20do%20to%20create%20an%20accurate%20on,thousands%20of%20AWS%20customer%20testimonials.)
